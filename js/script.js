...
const PRODUCTS = [
  { id: 'herb-keeper', title: 'Herb-Keeper Pod System', category: 'kitchen', description: 'Snap fresh herbs into water-fed pods and they stay usable for weeks, not days.', price: 34.99, rating: 4.8, reviews: 1240, tags: ['featured', 'trending'], dateAdded: '2026-06-18', trendingScore: 92, usefulScore: 95, gradientIndex: 0 },
  { id: 'door-cushions', title: 'Silent-Close Door Cushions', category: 'home', description: 'Self-adhesive dampeners that stop doors from slamming — no drilling required.', price: 12.99, rating: 4.6, reviews: 860, tags: ['new', 'most-loved'], dateAdded: '2026-07-02', trendingScore: 70, usefulScore: 88, gradientIndex: 1 },
  { id: 'cable-strip', title: 'Magnetic Cable Organizer Strip', category: 'office', description: 'A slim magnetic rail that keeps charging cables snapped to the underside of your desk.', price: 16.99, rating: 4.7, reviews: 2103, tags: ['featured', 'editors-pick'], dateAdded: '2026-05-28', trendingScore: 75, usefulScore: 91, gradientIndex: 2 },
  { id: 'bt-tracker', title: 'Find-Anything Bluetooth Tracker', category: 'tech', description: 'A coin-sized tag that helps you locate keys, bags, or anything else through a phone app.', price: 24.99, rating: 4.9, reviews: 5602, tags: ['trending', 'most-loved'], dateAdded: '2026-06-05', trendingScore: 98, usefulScore: 90, gradientIndex: 3 },
  { id: 'packing-cubes', title: 'Compression Packing Cubes Set', category: 'travel', description: 'Six cubes that compress clothing by a third so carry-on-only trips actually work.', price: 29.99, rating: 4.8, reviews: 3021, tags: ['featured', 'editors-pick'], dateAdded: '2026-06-22', trendingScore: 80, usefulScore: 93, gradientIndex: 4 },
  { id: 'trunk-organizer', title: 'Trunk Organizer with Cooler Compartment', category: 'car', description: 'Collapsible trunk storage with a built-in insulated section for groceries or drinks.', price: 44.99, rating: 4.5, reviews: 512, tags: ['new'], dateAdded: '2026-07-08', trendingScore: 55, usefulScore: 78, gradientIndex: 5 },
  { id: 'massage-gun', title: 'Massage Gun Mini', category: 'fitness', description: 'Pocket-sized percussion massager with enough power for a full post-run recovery.', price: 59.99, rating: 4.7, reviews: 1899, tags: ['trending', 'featured'], dateAdded: '2026-06-10', trendingScore: 88, usefulScore: 85, gradientIndex: 0 },
  { id: 'drawer-dividers', title: 'Stackable Drawer Dividers', category: 'organization', description: 'Adjustable dividers that click together, so one set reconfigures for any drawer.', price: 19.99, rating: 4.6, reviews: 940, tags: ['editors-pick'], dateAdded: '2026-05-20', trendingScore: 60, usefulScore: 87, gradientIndex: 1 },
  { id: 'pry-tool', title: 'Titanium Pry Bar Keychain Tool', category: 'edc', description: 'A flat titanium bar that opens boxes, scrapes labels, and still fits on a keyring.', price: 14.99, rating: 4.9, reviews: 1567, tags: ['new', 'trending'], dateAdded: '2026-07-05', trendingScore: 84, usefulScore: 82, gradientIndex: 2 },
  { id: 'smart-bottle', title: 'Smart Hydration Water Bottle', category: 'smart-gadgets', description: "Tracks how much you drink and glows as a reminder when you're behind for the day.", price: 39.99, rating: 4.7, reviews: 2210, tags: ['featured', 'most-loved'], dateAdded: '2026-06-01', trendingScore: 76, usefulScore: 84, gradientIndex: 3 },
  { id: 'treat-ball', title: 'Interactive Treat-Dispensing Ball', category: 'pet', description: 'Rolls unpredictably and drops kibble, turning mealtime into twenty minutes of exercise.', price: 22.99, rating: 4.8, reviews: 1755, tags: ['trending'], dateAdded: '2026-06-14', trendingScore: 79, usefulScore: 80, gradientIndex: 4 },
  { id: 'sunrise-alarm', title: 'Sunrise Alarm Clock Light', category: 'lifestyle', description: 'Fades in like a sunrise over 30 minutes so you wake up before the alarm ever sounds.', price: 42.99, rating: 4.8, reviews: 3390, tags: ['editors-pick', 'new'], dateAdded: '2026-06-29', trendingScore: 71, usefulScore: 90, gradientIndex: 5 },
  { id: 'jar-opener', title: 'One-Handed Jar Opener', category: 'kitchen', description: "A textured lever that grips any lid size, so one twist opens jars sore hands can't.", price: 11.99, rating: 4.5, reviews: 674, tags: ['new'], dateAdded: '2026-07-01', trendingScore: 45, usefulScore: 83, gradientIndex: 0 },
  { id: 'laptop-riser', title: 'Adjustable Laptop Riser with Hidden Storage', category: 'office', description: 'Lifts your screen to eye level and hides a cable and drive compartment underneath.', price: 32.99, rating: 4.6, reviews: 1288, tags: ['most-loved'], dateAdded: '2026-05-15', trendingScore: 58, usefulScore: 86, gradientIndex: 1 },
  { id: 'travel-adapter', title: 'Universal Travel Adapter with USB-C PD', category: 'travel', description: 'Works in 150+ countries and fast-charges a laptop through a single USB-C port.', price: 27.99, rating: 4.9, reviews: 4120, tags: ['featured', 'most-loved'], dateAdded: '2026-06-08', trendingScore: 82, usefulScore: 92, gradientIndex: 2 },
  { id: 'passport-organizer', title: 'RFID-Blocking Passport Organizer', category: 'travel', description: 'Holds passports, boarding passes, and cards while blocking wireless skimming.', price: 18.99, rating: 4.4, reviews: 431, tags: ['new'], dateAdded: '2026-07-10', trendingScore: 40, usefulScore: 75, gradientIndex: 3 },
  { id: 'rfid-wallet', title: 'Slim RFID Wallet', category: 'edc', description: 'Carries eight cards in a case thinner than your phone, with a pop-up card release.', price: 28.99, rating: 4.7, reviews: 2789, tags: ['editors-pick', 'most-loved'], dateAdded: '2026-05-25', trendingScore: 68, usefulScore: 89, gradientIndex: 4 },
  { id: 'cat-groomer', title: 'Cat Self-Groomer Corner Brush', category: 'pet', description: 'Mounts on any wall corner so your cat brushes itself while you do literally nothing.', price: 13.99, rating: 4.5, reviews: 903, tags: ['new', 'trending'], dateAdded: '2026-07-06', trendingScore: 63, usefulScore: 77, gradientIndex: 5 },
];
...
function productCardHTML(product) {
  ...
  return `
    <article class="product-card reveal" data-category="${product.category}">
      <div class="product-card__media grad-${product.gradientIndex}">
