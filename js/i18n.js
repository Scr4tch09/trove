...
const I18N = {
  en: {
    ...
    dealsEyebrow: 'Deals', dealsTitle: 'Price Drops', dealsSubtitle: 'Picks that got cheaper on Amazon since our last price check.',
    ribbonDeal: 'Deal', dealWas: 'before', dealNote: 'Compared with the price we last recorded — the price shown on Amazon at the time of purchase applies.',
    ...
    newsletterPrivacy: 'Unsubscribe anytime. By subscribing you agree to our <a href="datenschutz.html">Privacy Policy</a>.',
    ...
    priceNotice: 'Product prices and availability were last updated on August 9, 2026 and may have changed since — the price shown on Amazon at the time of purchase applies.',
    ...
    navFav: 'Saved items',
    merklisteEyebrow: 'Saved',
    merklisteTitle: 'Your saved products',
    merklisteEmpty: "You haven't saved anything yet. Tap the heart on any product to keep it here for later.",
    merklisteCta: 'Browse products',
  ...
  de: {
    ...
    dealsEyebrow: 'Angebote', dealsTitle: 'Aktuelle Preissenkungen', dealsSubtitle: 'Picks, die seit unserer letzten Preisprüfung bei Amazon günstiger geworden sind.',
    ribbonDeal: 'Angebot', dealWas: 'vorher', dealNote: 'Verglichen mit dem zuletzt von uns erfassten Preis — maßgeblich ist der zum Kaufzeitpunkt auf Amazon angezeigte Preis.',
    ...
    newsletterPrivacy: 'Jederzeit abbestellbar. Mit der Anmeldung stimmst du unserer <a href="datenschutz.html">Datenschutzerklärung</a> zu.',
    ...
    priceNotice: 'Angezeigte Preise und Verfügbarkeiten zuletzt aktualisiert am 9. August 2026 — maßgeblich ist der zum Kaufzeitpunkt auf Amazon angezeigte Preis.',
    ...
    favSave: 'Merken', favSaved: 'Gemerkt',
    navFav: 'Merkliste',
    merklisteEyebrow: 'Gespeichert',
    merklisteTitle: 'Deine Merkliste',
    merklisteEmpty: 'Du hast noch nichts gemerkt. Klick das Herz auf einem Produkt, um es hier für später zu speichern.',
    merklisteCta: 'Produkte entdecken',
