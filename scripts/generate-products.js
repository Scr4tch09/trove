  ...
  <header class="nav" id="top">
    <div class="container nav__inner">
      ...
      <nav class="nav__links" aria-label="Primary">
        ...
        <a href="/katalog.html" data-i18n="navCategories">Catalog</a>
        <a href="/about.html" data-i18n="navAbout">About</a>
        <a href="mailto:info@trovepicks.de" data-i18n="navContact">Contact</a>
      </nav>
      <div class="nav__actions">
        <div class="lang-select">
          <button type="button" class="btn--ghost-icon lang-toggle" data-lang-toggle aria-haspopup="listbox" aria-expanded="false" aria-label="Sprache wählen / Choose language" title="Sprache / Language"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"></circle><line x1="3" y1="12" x2="21" y2="12"></line><ellipse cx="12" cy="12" rx="4" ry="9"></ellipse></svg><span class="lang-toggle__code" data-lang-code>DE</span></button>
          <div class="lang-menu" data-lang-menu hidden role="listbox">
            <button type="button" class="lang-option" data-lang-switch="de" role="option"><svg class="lang-flag" viewBox="0 0 24 16" aria-hidden="true"><rect width="24" height="5.4" y="0" fill="#000"/><rect width="24" height="5.4" y="5.3" fill="#DD0000"/><rect width="24" height="5.4" y="10.6" fill="#FFCC00"/></svg>Deutsch</button>
            <button type="button" class="lang-option" data-lang-switch="en" role="option"><svg class="lang-flag" viewBox="0 0 24 16" aria-hidden="true"><rect width="24" height="16" fill="#012169"/><path d="M0 0 24 16M24 0 0 16" stroke="#fff" stroke-width="3"/><path d="M0 0 24 16M24 0 0 16" stroke="#C8102E" stroke-width="1.4"/><path d="M12 0v16M0 8h24" stroke="#fff" stroke-width="5"/><path d="M12 0v16M0 8h24" stroke="#C8102E" stroke-width="3"/></svg>English</button>
          </div>
        </div>
        <button type="button" class="btn--ghost-icon" data-search-open aria-label="Search products"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="7"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button>
        <a href="/merkliste.html" class="btn--ghost-icon nav-fav" aria-label="Merkliste" title="Merkliste"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"></path></svg><span class="nav-fav__count" hidden>0</span></a>
        ...
        <button type="button" class="btn--ghost-icon nav__toggle" data-nav-toggle aria-expanded="false" aria-controls="mobile-nav" aria-label="Menü öffnen / Open menu"><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="3.5" y1="7" x2="20.5" y2="7"></line><line x1="3.5" y1="12" x2="20.5" y2="12"></line><line x1="3.5" y1="17" x2="20.5" y2="17"></line></svg></button>
      </div>
    </div>
  </header>
...
<head>
  ...
  try{if(localStorage.getItem('tp-consent')==='granted'){gtag('consent','update',{ad_storage:'granted',ad_user_data:'granted',ad_personalization:'granted',analytics_storage:'granted'});}}catch(e){}
  </script>
  ...
  })(window,document,'script','dataLayer','GTM-WLXS2VP2');</script>
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WLXS2VP2"
